...
RP_MySQLConfig.Host = "tbd" -- This is the IP address of the MySQL host. Make sure the IP address is correct and in quotation marks (" ")
...
RP_MySQLConfig.Database_name = "SWTORRP" -- This is the name of the Database on the MySQL server. Contact the MySQL server host to find out what this is
